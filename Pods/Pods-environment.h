...
// Multipeer
#define COCOAPODS_POD_AVAILABLE_Multipeer
#define COCOAPODS_VERSION_MAJOR_Multipeer 0
#define COCOAPODS_VERSION_MINOR_Multipeer 1
#define COCOAPODS_VERSION_PATCH_Multipeer 1
